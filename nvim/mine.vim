...
hi StatusLineNC	cterm=bold	   ctermbg=black ctermfg=yellow  guibg=gold guifg=blue
...
" syntax highlighting
hi Comment    cterm=NONE ctermfg=White       gui=NONE guifg=red2
hi Constant   cterm=NONE ctermfg=DarkGreen   gui=NONE guifg=green3
hi Identifier cterm=NONE ctermfg=Blue        gui=NONE guifg=cyan4
hi PreProc    cterm=NONE ctermfg=DarkMagenta gui=NONE guifg=magenta3
hi Special    cterm=NONE ctermfg=LightRed    gui=NONE guifg=deeppink
hi Statement  cterm=bold ctermfg=Blue	     gui=bold guifg=blue
hi Type	      cterm=NONE ctermfg=cyan	     gui=bold guifg=blue
